...
import HireDialog from "@/components/dashboard/HireModal";
;
      ...
      <div className="grid lg:grid-cols-2 gap-12 items-start">
        ...
        <div>
          <div className="flex items-center gap-4">
            <h1 className="text-5xl font-black">{lawyer.name}</h1>

            <span
              className={`px-4 py-1 rounded-full text-white ${
                lawyer.status === "Available" ? "bg-green-500" : "bg-red-500"
              }`}
            >
              {lawyer.status}
            </span>
          ...
          <p className="mt-8 text-gray-600 leading-8">{lawyer.bio}</p>
          ...
          <div className="mt-12">
            ...
            <Button >Hire</Button> */}
            <HireDialog lawyer={lawyer}></HireDialog>
