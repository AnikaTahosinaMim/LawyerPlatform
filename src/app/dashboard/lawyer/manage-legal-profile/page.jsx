...
import { getLawyerProfile, updateLawyerProfile } from "@/lib/api/hiring";
...
export default function ManageLegalProfile() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      //   photo,
      // });
      const result = await updateLawyerProfile(lawyer._id, {
        ...lawyer,
        photo,
      });
    ...
    console.log(lawyer, "SUBMIT DATA");
    console.log(session.user.email, "email");
  };

  return (
    <div className="max-w-3xl mx-auto bg-white shadow rounded-xl p-8">
      <h2 className="text-3xl font-bold mb-8">Manage Legal Profile</h2>
